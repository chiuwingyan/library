...
<div class="container clearfix">
   ...
   <div class="main-wrap">
        ...
        <form action="${pageContext.request.contextPath }/booklist_update.action" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkForm()"/>
         <input type="hidden" name="id" value="${model.id}"/>
                    <table class="insert-tab" width="100%">
                        <tbody>
                                <th><i class="require-red">*</i>ISBN：</th>
                                <td>
                                    <input class="common-text required" value="${model.isbn }" id="isbn" name="isbn" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>图书名称：</th>
                                <td><input class="common-text" name="bookname" value="${model.bookname }" id="bookname" size="50" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>作者：</th>
                                <td><input class="common-text" value="${model.author }" name="author" id="author" size="50"  type="text"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>数量：</th>
                                <td><input class="common-text" name="count" value="${model.count }" id="count" size="50" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>出版社：</th>
                                <td><input class="common-text" name="publish" id="publish" value="${model.publish }" size="50"  type="text"></td>
                            </tr>
                            <tr>
						...
						<option value="${Booktype.booktype }" ${Booktype.booktype eq model.booktype?'selected':''} >${Booktype.booktype}</option>
					</c:forEach>
                                </select>
                            </td>
                        </tr>
