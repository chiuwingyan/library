	...
	<div class="container clearfix">
		...
		<div class="main-wrap">
            ...
            <div class="search-content">
                <form action="${pageContext.request.contextPath }/booklist_findByPage.action" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="search" id="">
                                    ...
                                    <option value="bookname" ${search.search eq "bookname"?'selected':'' }>图书名称</option>
                                    <option value="author" ${search.search eq "author"?'selected':'' }>作者</option>
                                    <option value="publish" ${search.search eq "publish"?'selected':'' }>出版社</option>
                                    <option value="booktype" ${search.search eq "booktype"?'selected':'' }>图书类型</option>
                                </select>
                            </td>
                            <th width="70">关键字:</th>
			...
			<div class="result-wrap">
					...
					<form id="customerForm" name="customerForm"
						action="${pageContext.request.contextPath }/booklist_findByPage.action"
						method=post >
								...
								<c:forEach items="${page.beanList}" var="Book">
									<tr
										...
										<td><a class="link-update"
											href="${pageContext.request.contextPath }/booklist_initUpdate.action?id=${Book.id}">修改</a>
											&nbsp;&nbsp; 
											<a class="link-del"
											 href="${pageContext.request.contextPath}/booklist_delete.action?id=${Book.id}"
