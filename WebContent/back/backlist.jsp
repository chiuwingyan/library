	...
	<div class="container clearfix">
		...
		<div class="main-wrap">
            ...
            <div class="search-content">
                <form action="${pageContext.request.contextPath }/back_findByPage.action" method="post">
			...
			<div class="result-wrap">
					...
					<form id="customerForm" name="customerForm"
						action="${pageContext.request.contextPath }/back_findByPage.action"
						method=post >
						 <div class="result-title">
                    <div class="result-list">
                        <a href="${pageContext.request.contextPath }/back_iniadd.action"><i class="icon-font"></i>还书登记</a>
					...
					<div class="result-content">
						<table id=grid
							...
							<tbody>
								...
								<c:forEach items="${page.beanList}" var="Back">
									<tr
