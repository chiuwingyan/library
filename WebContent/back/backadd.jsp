...
<div class="container clearfix">
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="../index.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath }/back_findByPage.action">已归还列表</a><span class="crumb-step">&gt;</span><span>还书登记</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
    

        <form action="${pageContext.request.contextPath }/back_add.action" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkForm()"/>
                    <table class="insert-tab" width="100%">
						...
						<option  tips="${Book.bookname }" value="${Book.isbn }" ${Book.isbn eq back.isbn?'selected':''} >${Book.isbn}</option>
					</c:forEach>
					  </select>
                            </td>
                            </tr>
                            <tr>
                                ...
                                <td><input class="common-text" name="book" value="${back.book }" id="book" size="50" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>条形码：</th>
                                <td><input class="common-text" value="${back.bar }" name="bar" id="bar" size="50"  type="text"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>归还人姓名：</th>
                                <td><input class="common-text" name="stuname" value="${back.stuname }" id="stuname" size="50" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>归还人学号：</th>
                                <td><input class="common-text" name="stuid" id="stuid" value="${back.stuid }" size="50"  type="text"></td>
                            </tr>
                            <tr>
                            <th width="120"><i class="require-red">*</i>归还日期：</th>
                            <td><input class="common-text" name="date" id="date" value="${back.date }" size="50"  type="text" readonly></td>
                        </tr>
								<tr>
                                <th></th>
                                <td>
